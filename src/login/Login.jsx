      ...
      <section className="px-6 md:px-24 lg:px-8 pb-12 lg:pb-20 bg-gradient-to-r from-rose-100 to-blue-100">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 md:space-y-7 lg:w-3/6 mx-auto">
          <div className="form-control">
            ...
            <input type="email" placeholder="Your email" {...register("email", { required: true })} className="input input-bordered input-accent" />
          ...
          <div className="form-control">
            ...
            />
            <label className="label">
              <p onClick={handleForgotPassword} className="label-text-alt link link-hover">
                Reset password?
              </p>
            </label>
          </div>
        ...
        <div className="lg:w-3/6 mx-auto">
          ...
          <div className="flex items-center justify-between">
            <button onClick={handleTwitterSignIn} className="btn btn-outline md:w-56">
              {" "}
              <img src={twitterLogo} alt="twitter" /> Twitter{" "}
            </button>
            <button onClick={handleGoogleSignIn} className="btn btn-outline md:w-56">
              {" "}
              <img src={googleLogo} alt="google" /> Google{" "}
            </button>
          </div>
        </div>
        <p className="lg:text-[18px] text-center text-gray-700 pt-4 lg:pt-8">
          To New College Booker?{" "}
